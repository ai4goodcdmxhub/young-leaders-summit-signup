...
const days = [
  {
    ...
    blocks: [
      ...
      },
      {
        time: "18:35 – 19:25",
        type: "talk",
        speaker: "Adriana Caballero",
        title: "Cómo diseñar clases que inspiren y conecten en tiempos de IA",
      },
      {
        time: "19:25 – 19:35",
        type: "sponsor",
      ...
      },
      {
        time: "19:35 – 20:25",
        type: "talk",
        speaker: "José Navalpotro",
        title: "Escuela, docentes e IAG: Una nueva educación",
      },
      {
        time: "20:25 – 20:30",
        type: "close",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        time: "19:35 – 20:25",
        type: "talk",
        speaker: "Lic. Diego Alejandro Balderas Espinosa & Dra. Ruby Aceneth Galván Gámez",
        title: "Arte y matemáticas: una fusión neurodidáctica",
      },
      {
        time: "20:25 – 20:30",
        type: "close",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: "talk",
        speaker: "Diana Rubio",
        title: "IA con Propósito: La Nueva Generación STEM",
      },
      {
        time: "20:25 – 20:30",
        type: "close",
          ...
          {days.map((day, di) => (
            ...
            >
              ...
              <div className="bg-primary text-primary-foreground rounded-t-xl px-5 py-3 text-center">
                <p className="text-xs font-display font-semibold uppercase tracking-widest opacity-80">
                  Marzo
                </p>
              ...
              <div className="flex flex-col gap-2 mt-2 flex-1">
                {day.blocks.map((block, bi) => (
                  <div
                    key={bi}
                    className={`rounded-lg border px-4 py-3 ${blockStyles[block.type as BlockType]}`}
                  >
