...
import joseLPhoto from "@/assets/speakers/jose-lizarraga.png";
  ...
  return (
    <section id="ponentes" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-display font-bold text-primary mb-3">Ponentes</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
          {speakers.map((speaker, i) => (
            ...
            >
              ...
              {speaker.talk && (
                <p className="text-xs text-muted-foreground italic leading-snug">"{speaker.talk}"</p>
              )}
            </motion.div>
          ))}
        </div>
